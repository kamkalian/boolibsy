...
class Barcode128:
    ...
    def __init__(self, hash_id, caption, width=60, height=25):
        ...
        self.code = self.makeCode(hash_id)
    ...
    def save(self, filename):
        ...
        # datei öffnen
        fp = open(filename + ".svg", "w")

        # header für svg schreiben
        fp.write("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n")
        fp.write("<!DOCTYPE svg PUBLIC '-//W3C//DTD SVG 1.1//EN'\n")
        fp.write("'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'>\n")
        fp.write(
            "<svg height=\"" + str(self.height) + "mm\" version=\"1.1\" width=\"" + str(self.width) + "mm\""
            " xmlns=\"http://www.w3.org/2000/svg\">\n")

        # weiße Fläche und caption als Text über dem Barcode setzen
        fp.write("<g id=\"barcode_group\">\n")
        ...
        for bar in self.code:
            ...
            if bar == "1":
                ...
                fp.write(
                    "<rect height=\"" + str(self.height/4) + "mm\" style=\"fill:white;\" width=\"" + str(bar_width) + "mm\""
                    " x=\"" + str(1+(i * bar_width)) + "mm\" y=\"" + str(self.height/3) + "mm\"/>\n"
                )
